...
- **Create an agent** — `keelson workflow run chamber-genesis --arguments "a terse SRE who reasons about blast radius"` (or ask chat to create one). It authors a Mind you'll see seated in the Chamber panel.
