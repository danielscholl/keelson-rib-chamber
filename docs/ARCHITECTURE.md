...
| [Reference](https://danielscholl.github.io/keelson-rib-chamber/reference/) | The exact contract: the Chamber surface, the `rib:chamber:*` snapshot keys, the eight workflows, the chat tools and commands, the six room strategies, and the on-disk data. |
