---
title: Workflows
description: The five workflows the Chamber rib contributes to the catalog, each defined in code with no YAML file
sidebar:
  order: 3
---

Chamber contributes five workflows to the catalog. They are defined in code, in
...
two are single prompt turns that author content.
