...
A **strategy** decides only one thing: who acts next. Given the room and its
transcript, it returns the next step, speak (one Mind), speak in parallel (a whole
round at once), moderate, or end, and nothing more. The driver owns everything with a
