...
// not rotate by turnIndex: every participant speaks each round. At budget
// exhaustion, the last speaker writes the closing synthesis.
export const concurrent: Strategy = ({ room, transcript }) => {
