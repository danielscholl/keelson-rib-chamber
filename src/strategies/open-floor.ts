...
// structural cases (not active / no participants); otherwise the
...
// strategy reads the transcript only through speakerCounts and never parses. At
// budget exhaustion, the last speaker writes the closing synthesis.
