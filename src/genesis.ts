// Slug utilities for Minds: derive a path-safe directory slug from a name and
// guard it against traversal. Genesis *authoring* (the prompt that writes a soul)
// now lives in the chamber-genesis workflow + the chamber_emit_genesis tool; this
// file is just the naming/safety primitives they and the minds store share.
